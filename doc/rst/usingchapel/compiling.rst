...
If Z shell user want tab-autocompletion they need to export or copy the 
$CHPL_HOME/util/_chapel-zsh-completion to their fpath.
They will also need to add the following into their ~/.zshrc
